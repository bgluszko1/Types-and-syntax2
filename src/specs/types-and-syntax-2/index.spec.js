describe('default parameters - types and syntax - 2', () => {
    test('defines objects precisely', () => {
        ...
        expect(instances[-1]).toEqual(true);
    });
})
...
describe('creating own object with properties and methods - types and syntax - 2', () => {
    ...
    beforeEach(() => {
        ...
        car = {
            ...
            stopEngine() {
                return this.engineRunning = false;
            },
    ...
    test('extending an object with new properties', () => {
        ...
        newCar = {
            climatronicOn: false,
            startClimatronic() {
                return this.climatronicOn = true;
            },
            stopClimatronic() {
                return this.climatronicOn = false;
            }
        }
...
describe('creating functions with constructors - types and syntax - 2', () => {
    ...
    test('should have own properties', () => {
        ...
        let car;
        car = new CarConstructor("string", "string", "string");
        expect(car.name).toEqual("string");
        expect(car.model).toEqual("string");
        expect(car.color).toEqual("string");
    });
    ...
    test('checking methods logic', () => {
        ...
        let car;
        car = new CarConstructor("Volvo", "Costam", "black");
        car = {
            name: "Volvo",
            model: "Costam",
            color: "black",
        ...
        expect(car.getModel()).toEqual("Costam");
